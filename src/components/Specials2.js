...
import specials2 from '../assets/images/specials2.jpg';
  ...
  return (
    <div className="highlight-items">
      ...
      <div className="item-wrapper">
        ...
        <p>
        Au Bruchetta is made from grilled bread that has been smeared with garlic and seasoned with olive oil. It's infused with the aroma of smoky embers.
        </p>
        <button onClick={redirectToServices}>
          Order for delivery
          <svg 
            width="20" 
            height="20" 
